    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="inscription_user">Ajouter Utilisateur <span class="sr-only">(current)</span></a>
            </li>
...
<br><br><br><br>
<div style="text-align: center;"><h1> Utilisateurs </h1>
    <br><br>
        ...
        <table  class=" table table-striped">
            ...
            @foreach($users as $user)
                <tr>
                    ...
                    <td>{{$user->jury_id}}</td>
                    <td>{{$user->students_id}}</td>
                    <td>{{$user->tuteur_id}}</td>
                </tr>
        @endforeach
